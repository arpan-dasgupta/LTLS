...
class pairintint(_object):
    ...
    def __init__(self, *args):
        this = _example.new_pairintint(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_setmethods__["first"] = _example.pairintint_first_set
    __swig_getmethods__["first"] = _example.pairintint_first_get
    if _newclass:
        first = _swig_property(_example.pairintint_first_get, _example.pairintint_first_set)
    __swig_setmethods__["second"] = _example.pairintint_second_set
    __swig_getmethods__["second"] = _example.pairintint_second_get
    if _newclass:
        second = _swig_property(_example.pairintint_second_get, _example.pairintint_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
    ...
    def __setitem__(self, index, val):
        if not (index % 2):
            ...
            self.second = val
    __swig_destroy__ = _example.delete_pairintint
    __del__ = lambda self: None
pairintint_swigregister = _example.pairintint_swigregister
...
class vectorpairintint(_object):
    ...
    def iterator(self):
        return _example.vectorpairintint_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.vectorpairintint___nonzero__(self)

    def __bool__(self):
        return _example.vectorpairintint___bool__(self)

    def __len__(self):
        return _example.vectorpairintint___len__(self)

    def __getslice__(self, i, j):
        return _example.vectorpairintint___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.vectorpairintint___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.vectorpairintint___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.vectorpairintint___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.vectorpairintint___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.vectorpairintint___setitem__(self, *args)

    def pop(self):
        return _example.vectorpairintint_pop(self)

    def append(self, x):
        return _example.vectorpairintint_append(self, x)

    def empty(self):
        return _example.vectorpairintint_empty(self)

    def size(self):
        return _example.vectorpairintint_size(self)

    def swap(self, v):
        return _example.vectorpairintint_swap(self, v)

    def begin(self):
        return _example.vectorpairintint_begin(self)

    def end(self):
        return _example.vectorpairintint_end(self)

    def rbegin(self):
        return _example.vectorpairintint_rbegin(self)

    def rend(self):
        return _example.vectorpairintint_rend(self)

    def clear(self):
        return _example.vectorpairintint_clear(self)

    def get_allocator(self):
        return _example.vectorpairintint_get_allocator(self)

    def pop_back(self):
        return _example.vectorpairintint_pop_back(self)

    def erase(self, *args):
        return _example.vectorpairintint_erase(self, *args)

    def __init__(self, *args):
        this = _example.new_vectorpairintint(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _example.vectorpairintint_push_back(self, x)

    def front(self):
        return _example.vectorpairintint_front(self)

    def back(self):
        return _example.vectorpairintint_back(self)

    def assign(self, n, x):
        return _example.vectorpairintint_assign(self, n, x)

    def resize(self, *args):
        return _example.vectorpairintint_resize(self, *args)

    def insert(self, *args):
        return _example.vectorpairintint_insert(self, *args)

    def reserve(self, n):
        return _example.vectorpairintint_reserve(self, n)

    def capacity(self):
        return _example.vectorpairintint_capacity(self)
    __swig_destroy__ = _example.delete_vectorpairintint
    __del__ = lambda self: None
vectorpairintint_swigregister = _example.vectorpairintint_swigregister
vectorpairintint_swigregister(vectorpairintint)

class vectorpairdoublevector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, vectorpairdoublevector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, vectorpairdoublevector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _example.vectorpairdoublevector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.vectorpairdoublevector___nonzero__(self)

    def __bool__(self):
        return _example.vectorpairdoublevector___bool__(self)

    def __len__(self):
        return _example.vectorpairdoublevector___len__(self)

    def __getslice__(self, i, j):
        return _example.vectorpairdoublevector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.vectorpairdoublevector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.vectorpairdoublevector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.vectorpairdoublevector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.vectorpairdoublevector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.vectorpairdoublevector___setitem__(self, *args)

    def pop(self):
        return _example.vectorpairdoublevector_pop(self)

    def append(self, x):
        return _example.vectorpairdoublevector_append(self, x)

    def empty(self):
        return _example.vectorpairdoublevector_empty(self)

    def size(self):
        return _example.vectorpairdoublevector_size(self)

    def swap(self, v):
        return _example.vectorpairdoublevector_swap(self, v)

    def begin(self):
        return _example.vectorpairdoublevector_begin(self)

    def end(self):
        return _example.vectorpairdoublevector_end(self)

    def rbegin(self):
        return _example.vectorpairdoublevector_rbegin(self)

    def rend(self):
        return _example.vectorpairdoublevector_rend(self)

    def clear(self):
        return _example.vectorpairdoublevector_clear(self)

    def get_allocator(self):
        return _example.vectorpairdoublevector_get_allocator(self)

    def pop_back(self):
        return _example.vectorpairdoublevector_pop_back(self)

    def erase(self, *args):
        return _example.vectorpairdoublevector_erase(self, *args)

    def __init__(self, *args):
        this = _example.new_vectorpairdoublevector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _example.vectorpairdoublevector_push_back(self, x)

    def front(self):
        return _example.vectorpairdoublevector_front(self)

    def back(self):
        return _example.vectorpairdoublevector_back(self)

    def assign(self, n, x):
        return _example.vectorpairdoublevector_assign(self, n, x)

    def resize(self, *args):
        return _example.vectorpairdoublevector_resize(self, *args)

    def insert(self, *args):
        return _example.vectorpairdoublevector_insert(self, *args)

    def reserve(self, n):
        return _example.vectorpairdoublevector_reserve(self, n)

    def capacity(self):
        return _example.vectorpairdoublevector_capacity(self)
    __swig_destroy__ = _example.delete_vectorpairdoublevector
    __del__ = lambda self: None
vectorpairdoublevector_swigregister = _example.vectorpairdoublevector_swigregister
vectorpairdoublevector_swigregister(vectorpairdoublevector)
...
class mapstringdouble(_object):
    ...
    def __init__(self, *args):
        this = _example.new_mapstringdouble(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    __del__ = lambda self: None
mapstringdouble_swigregister = _example.mapstringdouble_swigregister
...
class vectorvector(_object):
    ...
    def iterator(self):
        return _example.vectorvector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _example.vectorvector___nonzero__(self)

    def __bool__(self):
        return _example.vectorvector___bool__(self)

    def __len__(self):
        return _example.vectorvector___len__(self)

    def __getslice__(self, i, j):
        return _example.vectorvector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _example.vectorvector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _example.vectorvector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _example.vectorvector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _example.vectorvector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _example.vectorvector___setitem__(self, *args)

    def pop(self):
        return _example.vectorvector_pop(self)

    def append(self, x):
        return _example.vectorvector_append(self, x)

    def empty(self):
        return _example.vectorvector_empty(self)

    def size(self):
        return _example.vectorvector_size(self)

    def swap(self, v):
        return _example.vectorvector_swap(self, v)

    def begin(self):
        return _example.vectorvector_begin(self)

    def end(self):
        return _example.vectorvector_end(self)

    def rbegin(self):
        return _example.vectorvector_rbegin(self)

    def rend(self):
        return _example.vectorvector_rend(self)

    def clear(self):
        return _example.vectorvector_clear(self)

    def get_allocator(self):
        return _example.vectorvector_get_allocator(self)

    def pop_back(self):
        return _example.vectorvector_pop_back(self)

    def erase(self, *args):
        return _example.vectorvector_erase(self, *args)

    def __init__(self, *args):
        this = _example.new_vectorvector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _example.vectorvector_push_back(self, x)

    def front(self):
        return _example.vectorvector_front(self)

    def back(self):
        return _example.vectorvector_back(self)

    def assign(self, n, x):
        return _example.vectorvector_assign(self, n, x)

    def resize(self, *args):
        return _example.vectorvector_resize(self, *args)

    def insert(self, *args):
        return _example.vectorvector_insert(self, *args)

    def reserve(self, n):
        return _example.vectorvector_reserve(self, n)

    def capacity(self):
        return _example.vectorvector_capacity(self)
    __swig_destroy__ = _example.delete_vectorvector
    __del__ = lambda self: None
vectorvector_swigregister = _example.vectorvector_swigregister
...
get_top_k2 = _example.get_top_k2
