...
class pairintint(object):
    ...
    def __init__(self, *args):
        _example.pairintint_swiginit(self, _example.new_pairintint(*args))
    first = property(_example.pairintint_first_get, _example.pairintint_first_set)
    second = property(_example.pairintint_second_get, _example.pairintint_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
...
# Register pairintint in _example:
_example.pairintint_swigregister(pairintint)
...
class vectorpairintint(object):
    ...
    def __init__(self, *args):
        _example.vectorpairintint_swiginit(self, _example.new_vectorpairintint(*args))
...
# Register vectorpairintint in _example:
_example.vectorpairintint_swigregister(vectorpairintint)

class vectorpairdoublevector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        _example.vectorpairdoublevector_swiginit(self, _example.new_vectorpairdoublevector(*args))
...
class vectorvector(object):
    ...
    def __init__(self, *args):
        _example.vectorvector_swiginit(self, _example.new_vectorvector(*args))
...
# Register vectorvector in _example:
_example.vectorvector_swigregister(vectorvector)
